class Models{
    ...
    */
    buscaPlacaForce(){
      ...
      var placa = jQuery("#filtroTabela").val();

      stopAnimationPlaca();
      jQuery("#textoPlaca").html(placa);

      aviso("Pesquisando Placa...","Estamos pesquisando a sua placa, aguarde...");

      // INICIO CHAMADA AJAX
      var request = $.ajax({

        method: "POST",
        url: "https://diogenesjunior.com.br/api/carros",
        data:{placa:placa}
    ...
    request.done(function (dados) {            
        ...
        fecharAviso();
        console.log("%c RETORNO DA PLACA","background:#ff0000;color:#fff;");
        console.log(dados);
        

        if(dados.dados.dados.error){
          aviso("Oops! Algo deu errado",`${dados.dados.dados.message}`);
        }

        var totPlacas = localStorage.getItem("totPlacas");
        ...
        localStorage.setItem(`placas[${totPlacas}]`,JSON.stringify(dados.dados.dados.response));
        localStorage.setItem(`placaPrefix[${totPlacas}]`,placa);


        totPlacas = parseInt(totPlacas) + 1;
        localStorage.setItem("totPlacas",totPlacas);

        console.log(dados.dados.dados.response.MARCA);
        ...
        jQuery("#insertResultados").append(`
                                          ...
                                          <tbody>
                                            <tr>
                                              <td style="font-weight:bold;padding:5px;">MARCA</td>
                                              <td style="padding:5px;">${dados.dados.dados.response.MARCA}</td>
                                            </tr>
                                            <tr>
                                              <td style="font-weight:bold;padding:5px;">MODELO</td>
                                              <td style="padding:5px;">${dados.dados.dados.response.MODELO}</td>
                                            </tr>
                                            <tr>
                                              <td style="font-weight:bold;padding:5px;">VERSÃO</td>
                                              <td style="padding:5px;">${dados.dados.dados.response.VERSAO}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                              ...
                                              <td style="padding:5px;">${dados.dados.dados.response.chassi}</td>
                                            </tr>
                                            <tr>
                                              <td style="font-weight:bold;padding:5px;">COR</td>
                                              <td style="padding:5px;">${dados.dados.dados.response.cor}</td>
                                            </tr>
                                            <tr>
                                              <td style="font-weight:bold;padding:5px;">FURTO?</td>
                                              <td style="padding:5px;">${dados.dados.dados.response.dataAtualizacaoRouboFurto}</td>
                                            </tr>
                                            <tr>
                                              <td style="font-weight:bold;padding:5px;">PLACA MOD. ANTIGO</td>
                                              <td style="padding:5px;">${dados.dados.dados.response.placa_modelo_antigo}</td>
                                            </tr>
                                            <tr>
                                              <td style="font-weight:bold;padding:5px;">UF</td>
                                              <td style="padding:5px;">${dados.dados.dados.response.uf}</td>
                                            </tr>
                                            <tr>
                                              <td style="font-weight:bold;padding:5px;">CIDADE</td>
                                              <td style="padding:5px;">${dados.dados.dados.response.municipio}</td>
                                            </tr>
                                            <tr>
                                              <td style="font-weight:bold;padding:5px;">COMBUSTÍVEL</td>
                                              <td style="padding:5px;">${dados.dados.dados.response.combustivel}</td>
                                            </tr>
                                            <tr>
                                              <td style="font-weight:bold;padding:5px;">PASSAGEIROS</td>
                                              <td style="padding:5px;">${dados.dados.dados.response.quantidade_passageiro}</td>
                                            </tr>
                                            <tr>
                                              <td style="font-weight:bold;padding:5px;">EIXOS</td>
                                              <td style="padding:5px;">${dados.dados.dados.response.eixos}</td>
                                            </tr>
                                            </tbody></table>
                                                <style>
                                                /* Estilo base para a tabela */
                                                  ...
                                                  table tbody tr:nth-child(odd) {
                                                    background-color: #f2f2f2; /* Cor clara */
                                                  }

                                                  table tbody tr:nth-child(even) {
                                                    background-color: #ffffff; /* Cor padrão (branca) */
                                                  }
                                                  ...
                                                  table tbody tr:hover {
                                                    ...
                                                    cursor: pointer; /* Opcional: cursor de ponteiro ao passar */
                                                  }
                                                  </style>
    ...
    request.fail(function (dados) {
         ...
         console.log("API NÃO DISPONÍVEL (buscaPlacaForce)");
         console.log(dados);
    ...
    revisitarPlaca(placa){

          // Recupera a quantidade total de placas armazenadas
          var totPlacas   = localStorage.getItem("totPlacas");
          totPlacas       = totPlacas ? parseInt(totPlacas) : 0;
          var aPlaca      = []

          let placasArray = [];

          // Percorre os índices salvos e adiciona no array
          for (let i = 0; i < totPlacas; i++) {

              let placaData = localStorage.getItem(`placas[${i}]`);
              
              if (placaData) {
                placasArray.push(JSON.parse(placaData)); // Converte JSON para objeto e adiciona ao array
                let placaAtual = JSON.parse(placaData);
                if(placaAtual.placa==placa){
                  aPlaca = placaAtual;
                }
              }
          ...
          var htmlPlaca = `
                                          ...
                                          <img src="${aPlaca.logo}" style="display: block;margin-right: auto;width: 140px;margin-bottom: -18px;">
                                          <table>
                                          <tbody>
                                            <tr>
                                              <td style="font-weight:bold;padding:5px;">MARCA</td>
                                              <td style="padding:5px;">${aPlaca.MARCA}</td>
                                            </tr>
                                            <tr>
                                              <td style="font-weight:bold;padding:5px;">MODELO</td>
                                              <td style="padding:5px;">${aPlaca.MODELO}</td>
                                            </tr>
                                            <tr>
                                              <td style="font-weight:bold;padding:5px;">VERSÃO</td>
                                              <td style="padding:5px;">${aPlaca.VERSAO}</td>
                                            </tr>
                                            <tr>
                                              <td style="font-weight:bold;padding:5px;">ANO</td>
                                              <td style="padding:5px;">${aPlaca.ano}</td>
                                            </tr>
                                            <tr>
                                              <td style="font-weight:bold;padding:5px;">CHASSI</td>
                                              <td style="padding:5px;">${aPlaca.chassi}</td>
                                            </tr>
                                            <tr>
                                              <td style="font-weight:bold;padding:5px;">COR</td>
                                              <td style="padding:5px;">${aPlaca.cor}</td>
                                            </tr>
                                            <tr>
                                              <td style="font-weight:bold;padding:5px;">FURTO?</td>
                                              <td style="padding:5px;">${aPlaca.dataAtualizacaoRouboFurto}</td>
                                            </tr>
                                            <tr>
                                              <td style="font-weight:bold;padding:5px;">PLACA MOD. ANTIGO</td>
                                              <td style="padding:5px;">${aPlaca.placa_modelo_antigo}</td>
                                            </tr>
                                            <tr>
                                              <td style="font-weight:bold;padding:5px;">UF</td>
                                              <td style="padding:5px;">${aPlaca.uf}</td>
                                            </tr>
                                            <tr>
                                              <td style="font-weight:bold;padding:5px;">CIDADE</td>
                                              <td style="padding:5px;">${aPlaca.municipio}</td>
                                            </tr>
                                            <tr>
                                              <td style="font-weight:bold;padding:5px;">COMBUSTÍVEL</td>
                                              <td style="padding:5px;">${aPlaca.combustivel}</td>
                                            </tr>
                                            <tr>
                                              <td style="font-weight:bold;padding:5px;">PASSAGEIROS</td>
                                              <td style="padding:5px;">${aPlaca.quantidade_passageiro}</td>
                                            </tr>
                                            <tr>
                                              <td style="font-weight:bold;padding:5px;">EIXOS</td>
                                              <td style="padding:5px;">${aPlaca.eixos}</td>
                                            </tr>
                                            </tbody></table>
                                                <style>
                                                /* Estilo base para a tabela */
